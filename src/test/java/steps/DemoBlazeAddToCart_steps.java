...
public class DemoBlazeAddToCart_steps {
    ...
    public void user_clicks_add_to_cart_button() {
        ...
        blazeHomePage.addToCartButton.click();
        Flow.wait(1000);
    }
    @Then("user should see {string} alert message and clicks Ok")
    public void user_should_see_alert_message_and_clicks_ok(String message) {
    ...
    public void user_verifies_the_details_of_the_added_product() {
        ...
        Assert.assertTrue(TempStorage.getData("price").contains(blazeHomePage.firstProductPrice.getText()));
    }
}
